...
const Shipping = () => {
  ...
  const save = (e) => {
    ...
    if (name && address && phone && post && province && city && area) {
      console.log("All fields are filled. Submitting...");
      setRes(true); // Example success action
    } else {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("http://localhost:5173/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                ...
                {products.map((p, i) => (
                  <div key={i} className="flex bg-white p-4 flex-col gap-2">
                    <div className="flex justify-start items-center">
                      <h2 className="text-md text-slate-600">name</h2>
                    </div>
                    {p.products.map((pt, j) => (
